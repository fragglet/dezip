...
static const char Far FilNamMsg[] = "%s:  bad filename length (%s)\n";
...
static const char Far GP11FlagsDiffer[] = "file #%lu (%s):\n\
...
static const char Far ExtFieldMsg[] = "%s:  bad extra field length (%s)\n";
static const char Far OffsetMsg[] =
    "file #%lu:  bad zipfile offset (%s):  %ld\n";
static const char Far ExtractMsg[] = "%8sing: %-22s  %s%s";
...
static const char Far SymLnkDeferred[] = "finishing deferred symbolic links:\n";
static const char Far SymLnkFinish[] = "  %-22s -> %s\n";
...
static const char Far InvalidResponse[] = "error:  invalid response [%s]\n";
...
static const char Far FileTruncated[] = "warning:  %s is probably truncated\n";
#endif
...
static const char Far NotEnoughMemCover[] =
...
static int
test_compr_eb(__GPRO__ uch *eb, unsigned eb_size, unsigned compr_offset,
